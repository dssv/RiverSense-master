...
<div ng-app="app">
    <div ng-controller="historico">
        <div class="row">
            <div class="span9">
                <div class="row">
                    <highcharts id="chart1" config="chartConfig" class="span9" ></highcharts>
                </div>
            </div>
        </div>
    </div>
    ...
    $('#container').highcharts({
        ...
        series: [{
            ...
            data: [null, null, null, null, null, 6, 11, 32, 110, 235, 369, 640,
                ...
                26956, 2712, 28999, 28965, 27826, 25579, 25722, 24826, 24605,
...
<div ng-app="app" ng-controller="historico">
  <div line-chart line-data='[
    { y: "2006", a: 100, b: 90 },
    { y: "2007", a: 75,  b: 65 },
    { y: "2008", a: 50,  b: 40 },
    { y: "2009", a: 75,  b: 65 },
...
<!-- <div class="box">
  <div class="box-header">
    <h1 class="box-title">Vazão do Rio</h1>
  </div>
  <div class="box-body text-center">
   <div id="container" style="min-width: 310px; height: 400px; margin: 0 auto"></div>
  </div>
  <div class="box-footer">
    <h3 class="box-title">Os níveis de vazão estão .<h3>
  </div>
</div> 
